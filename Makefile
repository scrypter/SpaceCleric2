...
UNREALROOTPATH = /media/tomd/Storage/Linux/Engines/UnrealEngine
GAMEPROJECTFILE =/media/tomd/Storage/Linux/UnrealProjects/SpaceCleric/SpaceCleric.uproject
...
TARGETS = \
	...
	UE4Server \
	SpaceCleric-Linux-Debug  \
	SpaceCleric-Linux-DebugGame  \
	SpaceCleric-Linux-Shipping  \
	SpaceCleric-Linux-Test  \
	SpaceCleric \
	SpaceClericEditor-Linux-Debug  \
	SpaceClericEditor-Linux-DebugGame  \
	SpaceClericEditor-Linux-Shipping  \
	SpaceClericEditor-Linux-Test  \
	SpaceClericEditor\
	configure
...
SpaceCleric-Linux-Debug:
	 $(PROJECTBUILD) SpaceCleric Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceCleric-Linux-DebugGame:
	 $(PROJECTBUILD) SpaceCleric Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceCleric-Linux-Shipping:
	 $(PROJECTBUILD) SpaceCleric Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceCleric-Linux-Test:
	 $(PROJECTBUILD) SpaceCleric Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceCleric:
	 $(PROJECTBUILD) SpaceCleric Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceClericEditor-Linux-Debug:
	 $(PROJECTBUILD) SpaceClericEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceClericEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SpaceClericEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceClericEditor-Linux-Shipping:
	 $(PROJECTBUILD) SpaceClericEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceClericEditor-Linux-Test:
	 $(PROJECTBUILD) SpaceClericEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceClericEditor:
	 $(PROJECTBUILD) SpaceClericEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
